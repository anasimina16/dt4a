...
* celles concernant le suivi des services : ces données, générées à partir de l’utilisation des services de  chaque réseau de transports, permettent de suivre la performance de chaque réseau : régularité, ponctualité, nombre de validations, fréquentation de telle ou telle ligne, tel ou tel point d'arrêt. Elles peuvent aussi simplement permettre de localiser certains services \(des parkings relais par exemple\) ou encore décrire des tarifs. Elles sont dans ce cas uniquement informationnelles.
